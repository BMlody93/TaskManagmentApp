...
- Create Angular project with ng: `ng new taskmanagmentapp.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`taskmanagmentapp.client.esproj`).
